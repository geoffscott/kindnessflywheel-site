# Kindness Flywheel — Contributor Guide

This guide is for anyone contributing to the Kindness Flywheel, whether you're writing by hand, using Claude Code Cloud, or working through an OpenClaw agent.
...
Include your name in the post frontmatter. If you'd like to provide more context about who you are and where your experience comes from, create an author file:
...
By contributing, you agree that your work is published under CC-BY 4.0. Anyone can use, quote, remix, and build on it with attribution to you.

## Questions

Open an issue on this repo. We're happy to help.
