...
So I'd been researching an alternative. [Beancount](https://github.com/beancount/beancount/){:target="_blank" rel="noopener"} is open-source, plain-text, double-entry accounting that you can version-control. It's human-readable, it belongs to you, and it implements five hundred years of accounting principles in a format that doesn't depend on a vendor.
...
Let me describe what I actually built. I exported my QuickBooks data, uploaded it to my agent, and developed a rudimentary Agent Skill that reads the export, imports it into Beancount, and produces clean financial statements that match Quickbooks reports. It's not production-ready for general use, but it met my needs tonight. More importantly, my agent then helped me solve the accounting problem that started all of this. I could see exactly where the discrepancy was, and I could give my accountant what he needed to file my taxes.
...
There are only a handful of major features between what I built tonight and something on which I could run my solo consulting business: bank transaction feeds, automated transaction categorization, simple invoicing, accountant-ready reports. Each is a solved problem. A similar feature set would cover many small businesses, as well as many small non-profits. I'm not claiming to be on the verge of replacing QuickBooks for a restaurant, a small consulting company, or an early stage tech startup yet. But the path is clear, even if the timeline is uncertain.

I think the value in business software will increasingly come from the accumulated context that an agent builds through interaction with a skilled user over time. My agent will get to know my business: where things are, my patterns, which clients are new, which expenses recur, how I categorize transactions, what my accountant needs and when. As that context deepens, I expect it to recognize anomalies and improve how we work together.
...
*Sources: [Luca Pacioli, Summa de arithmetica](https://en.wikipedia.org/wiki/Summa_de_arithmetica){:target="_blank" rel="noopener"} (1494). [Morningstar, 2025](https://www.morningstar.com/stocks/intuit-we-lower-moat-rating-cut-fair-value-estimate-reduced-certainty-around-ai){:target="_blank" rel="noopener"} (Intuit economic moat downgrade). [CPA Practice Advisor](https://www.cpapracticeadvisor.com/2025/06/27/intuit-rolls-out-ai-agents-for-quickbooks/163868/){:target="_blank" rel="noopener"} and [Intuit Investor Relations](https://investors.intuit.com/news-events/press-releases/detail/1258/intuit-introduces-ground-breaking-virtual-team-of-ai-agents-to-fuel-growth-for-businesses){:target="_blank" rel="noopener"}, July 2025 (Intuit AI agents launch). [Yahoo Finance](https://finance.yahoo.com/quote/INTU/){:target="_blank" rel="noopener"}, 2025 (Intuit stock performance). [Digits, March 2025](https://www.globenewswire.com/news-release/2025/03/10/3039814/0/en/AI-Startup-Digits-Takes-on-QuickBooks-with-the-World-s-First-Autonomous-General-Ledger-for-Accounting-Xero-Co-founder-Craig-Walker-Joins-Digits.html){:target="_blank" rel="noopener"} (Digits funding, leadership, and 11x revenue growth). [FTC final order, January 2024](https://www.ftc.gov/news-events/news/press-releases/2024/01/ftc-issues-opinion-finding-turbotax-maker-intuit-inc-engaged-deceptive-practices){:target="_blank" rel="noopener"} (Intuit deceptive advertising ruling). Timestamps and migration details from my own session, the night of March 31, 2026.*
