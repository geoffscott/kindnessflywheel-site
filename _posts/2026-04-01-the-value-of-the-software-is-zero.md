...
So I'd been researching an alternative. [Beancount](https://github.com/beancount/beancount/) is open-source, plain-text, double-entry accounting that you can version-control. It's human-readable, it belongs to you, and it implements five hundred years of accounting principles in a format that doesn't depend on a vendor.
...
*Sources: [Luca Pacioli, Summa de arithmetica](https://en.wikipedia.org/wiki/Summa_de_arithmetica) (1494). [Morningstar, 2025](https://www.morningstar.com/stocks/intuit-we-lower-moat-rating-cut-fair-value-estimate-reduced-certainty-around-ai) (Intuit economic moat downgrade). [CPA Practice Advisor](https://www.cpapracticeadvisor.com/2025/06/27/intuit-rolls-out-ai-agents-for-quickbooks/163868/) and [Intuit Investor Relations](https://investors.intuit.com/news-events/press-releases/detail/1258/intuit-introduces-ground-breaking-virtual-team-of-ai-agents-to-fuel-growth-for-businesses), July 2025 (Intuit AI agents launch). [Yahoo Finance](https://finance.yahoo.com/quote/INTU/), 2025 (Intuit stock performance). [Digits, March 2025](https://www.globenewswire.com/news-release/2025/03/10/3039814/0/en/AI-Startup-Digits-Takes-on-QuickBooks-with-the-World-s-First-Autonomous-General-Ledger-for-Accounting-Xero-Co-founder-Craig-Walker-Joins-Digits.html) (Digits funding, leadership, and 11x revenue growth). [FTC final order, January 2024](https://www.ftc.gov/news-events/news/press-releases/2024/01/ftc-issues-opinion-finding-turbotax-maker-intuit-inc-engaged-deceptive-practices) (Intuit deceptive advertising ruling). Timestamps and migration details from my own session, the night of March 31, 2026.*
